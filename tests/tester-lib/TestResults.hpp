    ...
    */
    class TestResults {
        private:
            ...
            /**
             * @brief The failure message of the test, if any.
             */
        ...
        public:
             ...
             */
            [[nodiscard]] bool get_passed() const { return passed; }

            /**
             * @brief Fails the test.
             */
            void fail(std::string reason) { passed = false; failure_message = std::move(reason); }

            /**
             * @brief Gets the failure message of the test, if any.
             * @return The failure message of the test, if any.
             */
            [[nodiscard]] const std::optional<std::string> &get_failure_message() const { return failure_message; }

            /**
             * @brief Gets the warnings generated by the test.
             * @return The warnings generated by the test.
             */
            [[nodiscard]] const TestWarnings &get_warnings() const { return warnings; }
             ...
             */
            [[nodiscard]] std::size_t get_warnings_count() const { return warnings.size(); }
    };
