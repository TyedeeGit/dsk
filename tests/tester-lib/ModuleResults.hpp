        ...
        private:
            ...
            void update_totals() {
                ...
                for (const auto &test : this->tests) {
                    if (test.second.get_passed()) {
                        this->passed++;
                    } else {
                        this->fails[test.first] = *test.second.get_failure_message();
                    }
                    this->warnings[test.first] = test.second.get_warnings();
                }
            }
        public:
            /**
