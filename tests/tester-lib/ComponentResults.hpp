...
namespace TesterLib {
    ...
    class ComponentResults {
        private:
             ...
             */
            void update_totals() {
                // Initialize the number of total/passed tests and modules and the warnings generated.
                this->total_tests = 0;
                this->passed_tests = 0;
        ...
        public:
             ...
             */
            unsigned get_passed_modules() const { return this->passed_modules; }

            /**
             * @brief Gets the warnings generated by the component.
             * @return The warnings generated by the component.
             */
            ComponentWarnings get_warnings() const { return this->warnings; }
    };
